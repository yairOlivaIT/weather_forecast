            ...
            <div className="m-auto w-full h-40">
                <div className="flex flex-col">
                    <div className="flex flex-row m-auto">
                        <svg className="w-8 h-8 m-auto text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="text-lg text-center p-4 text-white">{moment(consolidated_weather[0].applicable_date).format('LL')}</p>  
                </div>
            </div>
            <div className="flex flex-col">
                <div className="w-full  m-auto pr-8">
                    <img className="w-50 m-auto" src={weatherState} alt={weatherStateDesc}/>
                </div>

                <div className="m-auto w-full h-40">
                    <p className="text-8xl text-center p-8 text-white font-sans">{parseInt(consolidated_weather[0].the_temp)}<span className="text-6xl text">°C</span></p>
                </div>
                <div className="m-auto w-full">
                    <p className="text-2xl text-center p-8 text-white">{weatherStateDesc}</p>
                </div>
            </div>
        </aside> 
    )
