    ...
    return (
        <div className="flex flex-col bg-gray-800 w-80 md:w-full">
            <div className="w-full p-8">
                <p className="text-center text-white text-xl">{moment(applicable_date).format('dddd')}</p>
            </div>
            <div className="w-full m-auto pr-3">
                <img className="w-16 m-auto" src={weatherState} alt={weatherStateDesc}/>
            </div>
            <div className="flex flex-row justify-around">
                <p className="text-center text-white text-xl py-12 md:py-8 font-sans">{parseInt(min_temp)}<span className="text">°C</span></p>
                <p className="text-center text-white text-xl py-12 md:py-8 font-sans">{parseInt(max_temp)}<span className="text">°C</span></p>
            </div>
        </div>
    )
}
